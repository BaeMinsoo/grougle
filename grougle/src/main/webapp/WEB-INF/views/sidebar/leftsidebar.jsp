...
<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.html">
				<img src="resources/grougle/dark-grougle.svg" alt="" class="dark-logo">
				<img src="resources/grougle/light-grougle.svg" alt="" class="light-logo">
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-copy"></span><span class="mtext">업무문서함</span>
						</a>
						<ul class="submenu">
