	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<form id="formmake" name="formmake" method="post" action="<%=request.getContextPath() %>/eform/makeform">
					<div class="page-body">
						<%-- <%@ include file="./formsheader.jsp"%> --%> <!-- 이거 살리고 formsheader 내용 빼주기 -->
						<div class="formsheader">
							<input class="forms_title" name="forms_title" placeholder="양식 제목 입력" required>
						...
						<button class="formcategorymodalopenbtn openBtn1">분류 선택</button>
					</div> <!-- page-body div -->
					...
					<div class="modal1 hidden1">
					  <div class="bg1"></div>
					  <div class="modalBox1">
					  <div id="editdepttitle">분류 선택</div>
					  	<div id="jstreeshow">
					  	...
					  	<div id="datainput1">
					  			<div>분류 선택</div>
					  			<input type="text" id="category_name" name="category_name_modal" placeholder="상위 분류 선택" readonly="readonly" required>
					  			<input type="text" id="category_no" name="category_no_modal" required hidden>
					  	</div>
					...
					<input type="text" id="category_name2" name="category_name" required hidden>
					<input type="text" id="category_no2" name="category_no" required hidden>
					<button id="submitbtn" type="button">양식생성</button>
			</form>
...
$("#submitbtn").on("click",function(){
	var conditiontosub1 = document.querySelector(".forms_title").value;
	var conditiontosub2 = document.querySelector("#category_name2").value;
	if(conditiontosub1 == ''){
		alert('양식의 제목을 작성하여 주시기 바랍니다.');
	}
	if($('.summernote').summernote('isEmpty')) {
		alert('양식의 내용을 작성하여 주시기 바랍니다.');
	    // cancel submit
	    return false;
	    //e.preventDefault();
	  }
	if(conditiontosub2 == ''){
		alert('양식의 분류를 선택하여 주시기 바랍니다.');
	}
	if(conditiontosub1 !== '' && conditiontosub2 !== ''){
		document.formmake.submit();
	}
});
