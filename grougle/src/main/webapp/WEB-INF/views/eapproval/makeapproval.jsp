	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">기안</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<form id="approvalmake" name="approvalmake" method="post" action="<%=request.getContextPath() %>/eapproval/makeapproval">
					<div class="page-body">
						<%-- <%@ include file="./formsheader.jsp"%> --%> <!-- 이거 살리고 formsheader 내용 빼주기 -->
						<div class="formsheader">
							<input class="draft_title" name="draft_title" placeholder="기안제목" value="${formsInfo.forms_title }" required>
							<button type="button" class="openBtn2">결재선 지정</button>
							<input class="drafter_id" name="drafter_id" placeholder="직원사번" value="${loginSsInfo.emp_no }" required readonly="readonly">
							...
							<input class="drafter_name" name="drafter_name" placeholder="사원명" value="${loginSsInfo.emp_name }" required readonly="readonly">
							...
							<table id="formlisttable">
										...
										<tr>
											<td><input class="first_approvaal_name approvaal_name" name="draft_first1" placeholder="1차결재자 성명" readonly="readonly"></td>
											<td><input class="second_approvaal_name approvaal_name" name="draft_second2" placeholder="2차결재자 성명" readonly="readonly"></td>
											<td><input class="third_approvaal_name approvaal_name" name="draft_third3" placeholder="3차결재자 성명" readonly="readonly"></td>
											<td><input class="fourth_approvaal_name approvaal_name" name="draft_fourth4" placeholder="4차결재자 성명" readonly="readonly"></td>
											<td><input class="fifth_approvaal_name approvaal_name" name="draft_fifth5" placeholder="5차결재자 성명" readonly="readonly"></td>
										</tr>
										<tr hidden>
											<td><input class="first_approvaal_no approvaal_empno" name="draft_first" placeholder="1차결재자 사번" readonly="readonly"></td>
											<td><input class="second_approvaal_no approvaal_empno" name="draft_second" placeholder="2차결재자 사번" readonly="readonly"></td>
											<td><input class="third_approvaal_no approvaal_empno" name="draft_third" placeholder="3차결재자 사번" readonly="readonly"></td>
											<td><input class="fourth_approvaal_no approvaal_empno" name="draft_fourth" placeholder="4차결재자 사번" readonly="readonly"></td>
											<td><input class="fifth_approvaal_no approvaal_empno" name="draft_fifth" placeholder="5차결재자 사번" readonly="readonly"></td>
										</tr>
										<tr>
						...
						<div class="formsbody">
							<textarea class="summernote" name="draft_content"></textarea>
						</div> <!-- formsbody div -->
					  ...
					  <div id="editdepttitle">결재선 지정</div>
					  	...
					  	<div id="datainput">
					  		...
					  		<hr style="border: 0px; background-color: #29627e; height: 4px;">
					  			<input id="emp_no_record" hidden></input>
					...
					<input type="text" id="category_name2" name="category_name" value="${formsInfo.category_name }" required hidden>
					<input type="text" id="category_no2" name="category_no" value="${formsInfo.category_no }" required hidden>
					<input type="text" id="final_approval" name="final_approval" required hidden>
					<input type="text" id="emp_no" name="emp_no" required hidden>
					<button id="submitbtn" type="button">기안하기</button>
			</form>
...
$("#submitbtn").on("click",function(){
	var conditiontosub0 = document.querySelector(".first_approvaal_no").value;
	var conditiontosub1 = document.querySelector(".first_approvaal_name").value;
	var conditiontosub2 = document.querySelector(".draft_title").value;
	var conditiontosub3 = document.querySelector(".drafter_id").value;
	var fifth = document.querySelector(".fifth_approvaal_name").value;
	var fourth = document.querySelector(".fourth_approvaal_name").value;
	var third = document.querySelector(".third_approvaal_name").value;
	var second = document.querySelector(".second_approvaal_name").value;
	var second = document.querySelector(".first_approvaal_name").value;
	if(conditiontosub1 == ''){
		alert('결재선을 지정하여 주시기 바랍니다.');
	}
	if(conditiontosub2 == '') {
		alert('제목을 작성하여 주시기 바랍니다.');
	  }
	if(conditiontosub3 == ''){
		alert('사원정보를 불러오지 못했습니다. 재로그인 후 다시 시도하여 주시기 바랍니다.');
	}
	if(conditiontosub1 !== '' && conditiontosub2 !== '' && conditiontosub3 !== ''){
		if(fifth !== ''){
			document.querySelector("#final_approval").value ='5';
			document.querySelector("#emp_no").value =conditiontosub0;
			document.approvalmake.submit();
		}
		if(fifth == '' && fourth !== ''){
			document.querySelector("#final_approval").value ='4';
			document.querySelector(".fifth_approvaal_no").value = '0';
			document.querySelector("#emp_no").value =conditiontosub0;
			document.approvalmake.submit();
		}
		if(fifth == '' && fourth == '' && third !== ''){
			document.querySelector("#final_approval").value ='3';
			document.querySelector(".fifth_approvaal_no").value = '0';
			document.querySelector(".fourth_approvaal_no").value = '0';
			document.querySelector("#emp_no").value =conditiontosub0;
			document.approvalmake.submit();
		}
		if(fifth == '' && fourth == '' && third == '' && second !== ''){
			document.querySelector("#final_approval").value ='2';
			document.querySelector(".fifth_approvaal_no").value = '0';
			document.querySelector(".fourth_approvaal_no").value = '0';
			document.querySelector(".third_approvaal_no").value = '0';
			document.querySelector("#emp_no").value =conditiontosub0;
			document.approvalmake.submit();
		}
		if(fifth == '' && fourth == '' && third == '' && second == '' && first !== ''){
			document.querySelector("#final_approval").value ='1';
			document.querySelector(".fifth_approvaal_no").value = '0';
			document.querySelector(".fourth_approvaal_no").value = '0';
			document.querySelector(".third_approvaal_no").value = '0';
			document.querySelector(".second_approvaal_no").value = '0';
			document.querySelector("#emp_no").value =conditiontosub0;
			document.approvalmake.submit();
		}
	}
...
$(document).on("click","#emptable",function(){
	...
	var emp_no = $(this).find('#emp_no').text();
	...
	document.querySelector("#emp_no_record").value = emp_no;
...
$("#select1").on("click",function(){
	var condition0 = document.querySelector("#emp_no_record").value;
	...
	if(second_value == '' && third_value == '' && fourth_value == '' && fifth_value == ''){
		...
		if(condition1 !== '' && condition2 !== '' && condition3 !== '' && condition4 !== ''){
			if(condition1 !== second_value && condition1 !== third_value && condition1 !== fourth_value && condition1 !== fifth_value){
				...
				document.querySelector(".first_approvaal_no").value = condition0;
		...
		if(condition1 !== '' && condition2 !== '' && condition3 !== '' && condition4 !== ''){
			if(condition1 !== first_value && condition1 !== third_value && condition1 !== fourth_value && condition1 !== fifth_value){
				if(condition3 < first_l_value){
					...
					document.querySelector(".second_approvaal_no").value = condition0;
		...
		if(condition1 !== '' && condition2 !== '' && condition3 !== '' && condition4 !== ''){
			if(condition1 !== first_value && condition1 !== second_value && condition1 !== fourth_value && condition1 !== fifth_value){
				if(condition3 < first_l_value && condition3 < second_l_value){
					...
					document.querySelector(".third_approvaal_no").value = condition0;
		...
		if(condition1 !== '' && condition2 !== '' && condition3 !== '' && condition4 !== ''){
			if(condition1 !== first_value && condition1 !== second_value && condition1 !== third_value && condition1 !== fifth_value){
				if(condition3 < first_l_value && condition3 < second_l_value && condition3 < third_l_value){
					...
					document.querySelector(".fourth_approvaal_no").value = condition0;
		...
		if(condition1 !== '' && condition2 !== '' && condition3 !== '' && condition4 !== ''){
			if(condition1 !== first_value && condition1 !== second_value && condition1 !== third_value && condition1 !== fourth_value){
				if(condition3 < first_l_value && condition3 < second_l_value && condition3 < third_l_value && condition3 < fourth_l_value){
					...
					document.querySelector(".fifth_approvaal_no").value = condition0;
...
$(document).ready(function() {
	...
	$('.summernote').summernote('code', '${formsInfo.forms_content}');
