		...
		<table width="1400" height="650">
			...
			<tr>
				<td width="100%" height="50%" align="left">
					<p align="left">
						<span style="padding-left: 160px"> 서비스 이용약관 동의</span>
					</p> <br> <textarea rows="20" cols="150">
수집하는 개인정보의 항목첫째, 회사는 회원가입, 원활한 고객상담, 각종 서비스의 제공을 위해 최초 회원가입 당시 아래와 같은 최소한의 개인정보를 필수항목으로 수집하고 있습니다.
회원가입
...
- 협력회사로부터의 제공
- 생성정보 수집 툴을 통한 수집
</textarea> <br> <input type="checkbox" id="check1" name="req"> <label
					for="check1"> Grougle 이용약관에 동의합니다.</label>
				</td>
			</tr>
			<tr>
				<td width="100%" height="50%" align="left">
					<p align="left">
						<span style="padding-left: 160px"> 개인정보 수집 이용동의</span>
					</p> <br> <textarea rows="20" cols="150">
수집하는 개인정보의 항목첫째, 회사는 회원가입, 원활한 고객상담, 각종 서비스의 제공을 위해 최초 회원가입 당시 아래와 같은 최소한의 개인정보를 필수항목으로 수집하고 있습니다.
회원가입
- 이름, 생년월일, 성별, 아이디, 비밀번호, 별명, 연락처(메일주소, 휴대폰 번호 중 선택), 가입인증정보
...
- 협력회사로부터의 제공
- 생성정보 수집 툴을 통한 수집
</textarea> <br> <input type="checkbox" id="check2" name="req"> <label
					for="check2">개인정보 수집 및 이용에 동의합니다.</label>
				</td>
			</tr>

			<tr>
				<td width="100%" height="50%" align="center"><input
					name="clauseAll" type="checkbox" value="1" id="clauseAll">
					<label for="clauseAll">전체 약관을 확인하고 모두 동의합니다.</label></td>
			</tr>
